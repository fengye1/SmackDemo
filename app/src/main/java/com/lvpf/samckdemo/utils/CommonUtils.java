package com.lvpf.samckdemo.utils;
...
public class CommonUtils {
	...
	public static final String URL_SIGN = "<lianjie_URL>";
	...
	public static String GetImageStr(String imagDir) {// 将语音文件转化为字节数组字符串，并对其进行Base64编码处理
		InputStream in = null;
		byte[] data = null;
		// 读取图片字节数组
		try {
	...
	// base64字符串转化成音频
	public static String GenerateVoice(String voicStr, String dir) { // 对字节数组字符串进行Base64解码并生成图片
	 ...
	 * 
	 * @param name
	 * @param isStop ,true为停止，false为
	 * 
	 */
	public static void playMusic(String name,boolean isStop) {
		try {
